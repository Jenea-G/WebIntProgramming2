...
async function loadEvents() {
  ...
  // why do we use await? (pauses the asyc function until the promise is settled)

  // what does response.json() return? Also returns a promise ! (that's why we use await)
  const data = await response.json();
